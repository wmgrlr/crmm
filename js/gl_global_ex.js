...
function lisActive_(ev) {
	  ...
	  //if ( _nameOpener !== 'Recorridos' &&  _nameOpener !== 'Visitantes' && _nameOpener !== 'departamentos1' && _nameOpener !== 'Marcaje QR' ){
	...
	//	}
	 // }
	  ...
	  //if (_nameOpener !== 'Recorridos' && _nameOpener !== 'Visitantes' && _nameOpener !== 'departamentos1'){
